...
| **Visualizações (EDA)** | Geração de histogramas, boxplots e gráficos analíticos. |
...
| **Leitura de Imagens** | **[OpenCV](https://docs.opencv.org/)** |
...
│
├── artifacts/
│ ├── eda/               # Resultados intermediários do EDA
